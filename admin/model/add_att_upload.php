...
<div id="item_container">
	...
	<div class="table-responsive">
		...
		?>
		  ...
		  <a href="../attendance.csv">Download Attedance Sheet Format</a><br /><label>Note :</label>This attendace sheet has specific format. If format not match it will not work properly. Here 0 reprent as absence and 1 represent as present.
	</form>
	<?php 
