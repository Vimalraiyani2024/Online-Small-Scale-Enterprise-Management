				...
				<tbody>
				  <tr>
				   <tr>
					...
					<?php 
						$rs=mysql_query("select pur_entry_id from  pur_entry_master order by pur_entry_id desc limit 1")or die(mysql_error());
				  ...
				  <td colspan="9">
							...
							<option selected="selected"> Select Purchase Type</option>
							<?php 
