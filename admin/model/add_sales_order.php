...
function CheckRecord(item_id)
{
	if (item_id.length > 0 ) { 
	 $.ajax({
			type: "POST",
			url: "fetch_data.php",
			data: "sales_order_id="+item_id,
			cache: false,
			beforeSend: function () { 		
			},
		...
		<div class="modal-content">		
			...
			<div id="btn-header">
				...
				if($_SESSION['ossem_user_type']==1)
					echo '<button type="submit" disabled="disabled" name="add_sales_order" id="btn-popup">Save</button>';
				else
					echo '<button type="submit" name="add_sales_order" id="btn-popup">Save</button>';
				?>
			</div>
			<div class="copy">				
				<div class="table-responsive">
				  ...
				  <tr>
					...
					<td><input type="text" onkeydown="return FixNumber(this.value,20);" placeholder="Order No" name="sorderid" class="form-control" onkeypress="return FixNumber(this.value,20);" onblur="CheckRecord(this.value);" required/></td>
				    <td colspan="2"></td>					
				</tr>
				<tr>
					<td>Customer</td>
				...
				<tr>					
					<td>Reference</td>
					<td> <input class="form-control" onkeydown="return FixNumber(this.value,20);" name="reference" type="text" placeholder="Reference" required/></td>	
					...
					<Td colspan="4">												
  					<table id="item_detail" class="table">
						...
						<tr>
							...
							<td style="text-align:right;"><input class="form-control" name="item_quantity" onkeypress="return FixNumber(this.value,5);" onkeydown="return isNumberKey(this);" type="text" id="item_quantity" style="text-align:right;max-width:100px" /></td>						
							<td colspan="2"><button class="add_field_button" id="btn-add">Add Item</button></td>
						</tr>
						</table>					
					</td>
				</tr>											
