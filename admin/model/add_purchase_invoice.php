...
<form action="" method="POST" id="form1">
	<div id="modal1">
		<div class="modal-content">		
			<div class="cf footer"><h2>Create New Purchase Invoice</h2></div>
			<div id="btn-header">
				<a href="#" id="close-box">Close</a>
				<?php
				if($_SESSION['ossem_user_type']==1)
					echo '<button type="submit" disabled="disabled" name="add_pur_invoice" id="btn-popup">Save</button>';
				else
					echo '<button type="submit" name="add_pur_invoice" id="btn-popup">Save</button>';
				?>
			</div>
			<div class="copy">				
				<div class="table-responsive">									
				  ...
				  <tr>
					...
					<td><input type="text"   class="form-control"  name="pur_id"  placeholder="Purchase Invoice No.	"required/></td>								
				    <td colspan="2"></td>
				</tr>
				<tr>
					<td>Supplier</td>
					...
					<td>Purchase Date</td>
					<td><input type="text" id="sale_quo_date" readonly class="form-control"  name="pur_date"  value="<?php echo date("d-m-Y"); ?>"  required/></td>								
				</tr>
				<tr>
					<td>Order No.-Date</td>
					<td>
					...
					<Td colspan="4">												
  					<table id="item_detail" class="table">
						...
						<tr>
							...
							<td style="text-align:right;"><input class="form-control" name="item_quantity" type="text" id="item_quantity" onkeypress="return FixNumber(this.value,8);"   onkeydown="return isNumberKey(this);" style="text-align:right;max-width:90px" /></td>						
