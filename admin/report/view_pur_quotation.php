...
if(isset($_REQUEST['tmpid']))
{
	...
	$list=$_REQUEST['list'];
	$rs1=mysql_query("select a.pur_qua_id,quo_date,supplier_name,address,city,state,pincode,mobile_no,phone_no,remark,reference,reference_date,tax,expiry_date,status from pur_qua_master a,supplier_master b where a.supplier_id=b.supplier_id and a.pur_qua_id='$tmpid'")or die(mysql_error());
...
<form action="" method="post" id="form1">	
			<div id="btn-header">		
			<a href="purchase.php?close=1" id="close-box">Close</a>
			<a href="purchase.php?print=purchase_quotation&id=<?php echo $row[0]; ?>" id="btn-print">Print</a>
			<a href="#purchase.php?did='.$row['pur_qua_id'].'& list=pur_quo_del" class="btn-delete">Cancel</a>
			<h3>Purchase Quotations</h3>	
				...
				<Td colspan="4">
					...
					<tr>
						<?php 	
							...
							$sub_total=0.0;	
							$tmp=0.0;						
							$rs=mysql_query("select *from pur_qua_detail where pur_qua_id='$row[0]'")or die(mysql_error());
