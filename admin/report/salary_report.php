...
<div id="item_container">
	<form action="" method="post" id="form1">	
		...
		<tr> 
			<th><label>Sr. No.<th><label>Employee Name<th><label>Total Days<th><label>Total Leave<th><label>Total Salary
		</tr>	
		<?php
		$i=1;$j=0;
		if(isset($_POST['OK']))
		{
			...
			{	
				...
				echo "<td align='right'>".$total_days."<td align='right'>".($total_days-$tmp_total)."<td align='right'>".number_format(ceil($salary),2)."</tr>";
			}			
		}
		?>	
</form>
