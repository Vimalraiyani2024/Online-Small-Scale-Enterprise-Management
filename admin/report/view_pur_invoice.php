...
<form action="" method="post" id="form1">	
			<div id="btn-header">		
			<a href="purchase.php?close=c_invoice" id="close-box">Close</a>
			<a href="#purchase.php?print=purchase_invoice&id='<?php echo $tmpid; ?>'" id="btn-print">Print</a>
			<a href="#purchase.php?del_id='.$row['pur_id'].'&list=pur_invoice_del" class="btn-delete">Cancel</a>
