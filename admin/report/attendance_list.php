...
<!--			<a href="#" id="btn-print">Print</a>-->
		...
		<table class="table table">
			...
			<td><input type="submit" id="btn-submit" name="OK" value="Report"/></td>
		</tr>		
		</table>
			</div>
		</div>
		...
		<tr> 
			<th><label>Sr. No.<th><label>Employee Name<th><label>Total Days<th><label>Attendance<th><label>Total Leave
		</tr>	
		<?php
		$i=1;$j=0;
		if(isset($_POST['OK']))
		{
			...
			if(mysql_num_rows($rs)=="")
				echo "<tr><td colspan='4' id='err-msg'>No Record Found For The <b>".$month_name." - ".$month_year."</b></tr>";
			else
				echo "<h4 align='center' id='err-msg'>Attendance Report Of <b>".$month_name." - ".$month_year."</b></h4>";
			...
			{	
				...
				echo "<td align='right'>".$total_days."<td align='right'>".$tmp_total."<td align='right'>".($total_days-$tmp_total)."<tr>";
			}			
		}
		?>		
