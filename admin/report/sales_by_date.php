<div id="item_container">
	<form action="" method="post" id="form1">	
		<div id="btn-header">		
			...
			<h4>Sales Date to Date Report</h4>	
			<br />
			...
			if (isset($_POST['to_date'])&& isset($_POST['from_date']))
				echo '<tr><td colspan="5"><b id="b-title">Sales From Date '.$_POST['from_date'].' To Date '.$_POST['to_date'].'</b></td></tr>';
			?>
        </div>			
		...
		<div class="table-responsive">
			...
			<?php 	
				...
				if(isset($_POST['show_sales_by_date']))
				{
					...
					$rs=mysql_query("select a.invoice_id,invoice_date,customer_name,(select sum(item_qty * item_price) from sales_detail where invoice_id=a.invoice_id) as subtotal,tax  from sales_master a,customer_master b where a.customer_id=b.customer_id and invoice_date >='$from_date' and invoice_date	<='$to_date'")or die(mysql_error());					
