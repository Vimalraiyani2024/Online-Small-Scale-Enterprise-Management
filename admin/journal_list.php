...
<form action="" method="post" role="form">
	<a href="#modal" id="btn-create">Create</a><br /><br />
		<h4 id="title">Journal Entry List</h4>
  <div class="table-responsive"> 
    <table class="table table-striped">
      <thead>
        <tr>
          <th style="text-align:right"><b id="b-title">Sr No</th>
          <th><b id="b-title">Journal No</th>
	...
	<?php
	 echo "<tr>";
	 $i=1;
	  $rs=mysql_query("select * from entry_master where entry_type='j' order by entry_id desc")or die(mysql_error());
...
<?php 
	include_once("model/add_journal.php");
 ?>